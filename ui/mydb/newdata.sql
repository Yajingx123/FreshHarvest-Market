...
(1,1,1,'2025-12-10','received', 1072.00),
(2,2,1,'2025-12-11','received', 2074.00),
(3,3,1,'2025-12-12','ordered',  0.00),
(4,1,2,'2025-12-10','received', 1226.00),
(5,2,2,'2025-12-12','received', 2994.50),
(6,3,2,'2025-12-13','pending',  0.00),
(7,1,3,'2025-12-11','received', 1071.00),
(8,2,3,'2025-12-12','ordered',  798.00),
(9,3,3,'2025-12-13','pending',  0.00);
...
('B1-FRU-001',4,1,30, 12,29.90,'2025-12-10',1,'2025-12-09','2025-12-18'),
-- 中南店五花肉：总进货40，当前库存25
('B1-MEAT-001',7,1,40, 25,28.90,'2025-12-11',2,'2025-12-10','2025-12-25'),
-- 中南店大虾：总进货20，当前库存3
('B1-SEA-001',12,1,20,  3,45.90,'2025-12-11',2,'2025-12-10','2026-01-30'),

-- 麓谷店番茄：总进货60，当前库存20
('B2-VEG-001',2,2,60, 20,7.90,'2025-12-10',4,'2025-12-09','2025-12-22'),
-- 麓谷店苹果：总进货40，当前库存9
('B2-FRU-001',5,2,40,  9,18.80,'2025-12-10',4,'2025-12-09','2026-01-10'),
-- 麓谷店牛腱子：总进货30，当前库存15
('B2-MEAT-001',8,2,30, 15,49.90,'2025-12-12',5,'2025-12-11','2025-12-28'),
-- 麓谷店三文鱼：总进货25，当前库存18（在库2+已售1=3，修正为3）
('B2-SEA-001',11,2,25,  3,59.90,'2025-12-12',5,'2025-12-11','2025-12-19'),

-- 梅溪湖店土豆：总进货50，当前库存35
('B3-VEG-001',3,3,50, 35, 9.90,'2025-12-11',7,'2025-12-10','2026-02-10'),
-- 梅溪湖店香蕉：总进货45，当前库存=在库1+损坏1=2（修正前7）
('B3-FRU-001',6,3,45,  2,12.80,'2025-12-11',7,'2025-12-10','2025-12-21'),
-- 梅溪湖店三黄鸡：总进货20，当前库存10
('B3-MEAT-001',9,3,20, 10,39.90,'2025-12-12',8,'2025-12-11','2025-12-26');

-- 9) 客户订单表（保持不变）
INSERT INTO CustomerOrder
(order_ID, customer_ID, order_date, branch_ID, total_amount, final_amount, status, shipping_address)
VALUES
(1,1,'2025-12-14 10:15:00',1,  27.00,27.00,'Completed','长沙市岳麓区中南大学XX号'),
(2,2,'2025-12-14 11:20:00',1,  59.90,59.90,'Completed','长沙市雨花区XX路66号'),
(3,3,'2025-12-15 09:00:00',1,  13.50,0.00,'Pending','长沙市开福区XX小区'),
(4,1,'2025-12-14 14:10:00',2,  69.90,69.90,'Completed','长沙市岳麓区麓谷XX号'),
(5,2,'2025-12-15 09:30:00',2,  59.90,0.00,'Pending','长沙市望城区XX号'),
(6,3,'2025-12-13 19:00:00',2,  45.90,0.00,'Cancelled','长沙市天心区XX号'),
(7,1,'2025-12-14 16:00:00',3,  32.70,32.70,'Completed','长沙市梅溪湖XX号'),
(8,2,'2025-12-15 10:00:00',3,  39.90,0.00,'Pending','长沙市梅溪湖XX号');
...
(4,5,'SI-B2-SA-001',11,59.90,'2025-12-12'),
(5,5,'SI-B2-SA-002',11,59.90,'2025-12-12');

-- 12) 订单明细表（保持不变）
INSERT INTO OrderItem (order_ID, item_ID, unit_price, product_ID,status) VALUES
(1,'SI-B1-SP-001',13.50,1,'completed'),  -- 匹配商品售价
(1,'SI-B1-SP-002',13.50,1,'completed'),  -- 匹配商品售价
(4,'SI-B2-SA-001',69.90,11,'completed'), -- 匹配商品售价
(3,'SI-B1-SP-004',13.50,1,'pending');    -- 匹配商品售价

-- 14) 供应商-商品进货价映射（按供应商品类生成）
INSERT INTO SupplierProduct (supplier_ID, product_ID, price)
SELECT
    s.supplier_ID,
    p.product_ID,
    p.unit_cost
...
JOIN products p ON (
    ...
    OR (s.supplier_category = '肉禽蛋' AND p.category_id IN (7, 8))
    OR (s.supplier_category = '水产' AND p.category_id IN (9, 10, 11))
);
